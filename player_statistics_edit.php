                ...
                <div class="container d-flex justify-content-center" style="margin-top:1%;margin-bottom:5%;">
                    ...
                    <form action="player_statistics.php?id_statistics_jugador=<?= $id_estad_jugador?>" class="formularios bg-light" id="formulario" name="formulario" method="POST" style="margin-top:1%;" enctype="multipart/form-data">
                        <div class="col-md-4 d-flex flex-row">
                            ...
                            <input type="text" name="id_estad_jugador" class="form-control col-md-2" value="<?php echo $id_estad_jugador; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                        ...
                        <div class="col-md-4 d-flex flex-row">
                            ...
                            <input type="text" name="partidos_jugados" class="form-control col-md-2" value="<?php echo $partidos_jugados; ?>" required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº goles registrados:</label>
                            <input type="text" name="goles" class="form-control col-md-2" value="<?php echo $goles; ?>"required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº remates registrados:</label>
                            <input type="text" name="remates" class="form-control col-md-2" value="<?php echo $remates; ?>" required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de asistencias:</label>
                            <input type="text" name="asistencias" class="form-control col-md-2" value="<?php echo $asistencias; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Minutos jugados registrados:</label>
                            <input type="text" name="min_jugados" class="form-control col-md-2" value="<?php echo $min_jugados; ?>" required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de faltas recibidas:</label>
                            <input type="text" name="faltas_recibidas" class="form-control col-md-2" value="<?php echo $faltas_recibidas; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de pases:</label>
                            <input type="text" name="pases" class="form-control col-md-2" value="<?php echo $pases; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de goles penalti:</label>
                            <input type="text" name="goles_penalti" class="form-control col-md-2" value="<?php echo $goles_penalti; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de balones recuperados:</label>
                            <input type="text" name="balones_recuperados" class="form-control col-md-2" value="<?php echo $balones_recuperdos; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de faltas cometidas:</label>
                            <input type="text" name="faltas_cometidas" class="form-control col-md-2" value="<?php echo $faltas_cometidas; ?>" required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de partidos titulares:</label>
                            <input type="text" name="partidos_titular" class="form-control col-md-2" value="<?php echo $partidos_titular; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de participaciones en partidos suplente:</label>
                            <input type="text" name="partidos_suplente" class="form-control col-md-2" value="<?php echo $partidos_suplente; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de goles por cabeza:</label>
                            <input type="text" name="goles_cabeza" class="form-control col-md-2" value="<?php echo $goles_cabeza; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de goles con pie derecho:</label>
                            <input type="text" name="goles_pie_der" class="form-control col-md-2" value="<?php echo $goles_pie_der; ?>" required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de goles con pie izquierdo:</label>
                            <input type="text" name="goles_pie_izq" class="form-control col-md-2" value="<?php echo $goles_pie_izq; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de penaltiz lanzados:</label>
                            <input type="text" name="penaltis_lanzados" class="form-control col-md-2" value="<?php echo $penaltis_lanzados; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de goles por falt directa:</label>
                            <input type="text" name="goles_falta_directa" class="form-control col-md-2" value="<?php echo $goles_falta_directa; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de goles recibidos:</label>
                            <input type="text" name="goles_recibidos" class="form-control col-md-2" value="<?php echo $goles_recibidos; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de partidos inhabilitados:</label>
                            <input type="text" name="partidos_inavilitados" class="form-control col-md-2" value="<?php echo $partidos_inavilitados; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de goles por centro:</label>
                            <input type="text" name="goles_centro" class="form-control col-md-2" value="<?php echo $goles_centro; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de goles por fuera:</label>
                            <input type="text" name="goles_fuera" class="form-control col-md-2" value="<?php echo $goles_fuera; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de paradas por centro:</label>
                            <input type="text" name="paradas_centro" class="form-control col-md-2" value="<?php echo $paradas_centro; ?>"  required>
                        </div>
                        <div class="col-md-4 d-flex flex-row">
                            <label for="inputEmail" class="form-label col-md-6">Nº de paradas por fuera:</label>
                            <input type="text" name="paradas_fuera" class="form-control col-md-2" value="<?php echo $paradas_fuera; ?>" required>
                        </div>
