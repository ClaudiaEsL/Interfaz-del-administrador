                    ...
                    <tbody>
                        ...
                        ?>
                         <th>
                            ...
                            <?php echo "<a title='Estadistica' class='btn btn-warning' style='color:white; margin-left:1%;' href='player_statistics.php?id_jugador=".$filas['id_jugador']."'><i class='bi bi-pencil-square'></i></a>"; ?>
                            </th>
                        </th>
                        <?php
                        }
