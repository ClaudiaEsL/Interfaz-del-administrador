    ...
    <div class="contenedor">
		<form action="<?=$_SERVER['PHP_SELF']?>" class="formulario" id="formulario" name="formulario" method="POST">
			<div class="contenedor-inputs">
				<input type="text" name="id_fisico" placeholder="ID_FISICO" required>
				<input type="text" name="estatura" placeholder="Estatura" required>
				<input type="text" name="peso" placeholder="Peso" required>
				<input type="text" name="pulso" placeholder="Pulso" required>
				<input type="text" name="tension_arterial" placeholder="Tension Arterial" required>
				<input type="text" name="control_vista" placeholder="Control de Vista" required>
				<input type="text" name="postura" placeholder="Postura" required>
				<input type="text" name="articulaciones" placeholder="Articulaciones" required>
				<input type="text" name="resistencia" placeholder="Resistencia" required>
				<input type="text" name="flexibilidad" placeholder="Flexibilidad" required>
